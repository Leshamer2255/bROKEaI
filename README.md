...
### Грошові команди
- `work` - працювати за гроші
- `gamble` - азартні ігри
- `steal` - красти гроші
- `bribe` - давати хабар
- `bank` - банківські операції
- `event` - випадкова подія
...
### Як отримати очки:
- Розгадування загадок: +100 очок +25$
- Знаходження секретних команд: +50 очок +15$
- Знаходження пасхалок: +25 очок +10$
- Успішний хак: +200 очок +100$
- Робота: +10 очок +20-70$
- Азартні ігри: ±5-15 очок ±10-120$
- Крадіжка: ±10-20 очок ±50-150$
- Хабар: +25 очок -50$

### Як отримати гроші:
- Робота: 20-70$ за раз
- Азартні ігри: ризиковано, але можна виграти
- Крадіжка: високий ризик, але велика винагорода
- Випадкові події: різні можливості заробітку
...
6. **Заробляйте гроші** - використовуйте work, gamble, event
7. **Приймайте рішення** - у випадкових подіях вибирайте стратегічно
8. **Ведіть історію** - команда history покаже ваші рішення
